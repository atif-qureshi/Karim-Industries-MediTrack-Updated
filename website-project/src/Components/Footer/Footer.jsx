    ...
    <footer>
      ...
      <div className="footer-column">
        ...
        <div className="address-section">
          ...
          <div className="address-item">
            ...
            <p className="address-text">karim.industries786@gmail.com
      ...
      <div className="footer-column">
        ...
        <div className="social-media">
          {/* Facebook */}
          <a
            href="https://www.facebook.com/photo/?fbid=454522203357511&set=a.454522190024179"
          ...
          {/* Instagram */}
          <a
            href="https://www.instagram.com/karimindustries?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
            className="social-icon"
