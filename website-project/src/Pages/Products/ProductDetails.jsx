...
import Triangular from './images/Triangular White.jpg';
...
const ProductDetail = () => {
    const { id } = useParams();
    const largeImageIds = [1, 2, 8, 9, 10, 11, 12, 14, 15, 19, 20, 21, 22, 23, 24];
    ...
    const isLargeImage = largeImageIds.includes(product.id);
        ...
        <div className="product-detail-page">
            ...
            <div className="product-detail-container">
                <div className="product-image">
                    ...
                    <img src={product.image} alt={product.name} className={isLargeImage ? "large-image" : ""} />
                </div>
